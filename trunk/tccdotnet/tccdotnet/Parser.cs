    ...
    public partial class Parser 
    {
        ...
        private void ParseGlobalDecl(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            if (tok.Type == TokenType.POINTER)
            {
                ...
                if (tok.Type != TokenType.POINTER)
                    tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.POINTER.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
                n = node.CreateNode(tok, tok.ToString() );
                node.Token.UpdateRange(tok);
                node.Nodes.Add(n);
            }
            ...
            tok = scanner.LookAhead(TokenType.LPAREN, TokenType.LARRAY, TokenType.EQUALS, TokenType.COMMA, TokenType.SEMICOL);
            switch (tok.Type)
            {
                ...
                case TokenType.SEMICOL:
                    ...
                    tok = scanner.LookAhead(TokenType.LARRAY, TokenType.EQUALS);
        ...
        private void ParseArray(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            do {
                ...
                if (tok.Type != TokenType.LARRAY)
                    tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.LARRAY.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
                n = node.CreateNode(tok, tok.ToString() );
                node.Token.UpdateRange(tok);
                node.Nodes.Add(n);
                ...
                if (tok.Type != TokenType.RARRAY)
                    tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.RARRAY.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
                n = node.CreateNode(tok, tok.ToString() );
                node.Token.UpdateRange(tok);
                node.Nodes.Add(n);
                tok = scanner.LookAhead(TokenType.LARRAY);
        ...
        private void ParseDecAssignment(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            tok = scanner.LookAhead(TokenType.NUMBER, TokenType.POINTER, TokenType.REFOPER, TokenType.IDENTIFIER, TokenType.LPAREN, TokenType.LBRACE);
            switch (tok.Type)
            {
                case TokenType.NUMBER:
           ...
           ParseNode n;
            ...
            while (tok.Type == TokenType.ARTOPERATOR)
            {
                ...
                if (tok.Type != TokenType.ARTOPERATOR)
                    tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.ARTOPERATOR.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
                n = node.CreateNode(tok, tok.ToString() );
                node.Token.UpdateRange(tok);
                node.Nodes.Add(n);
        ...
        private void ParseChar(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            if (tok.Type != TokenType.QUOT)
                tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.QUOT.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
            n = node.CreateNode(tok, tok.ToString() );
            node.Token.UpdateRange(tok);
            node.Nodes.Add(n);
        ...
        private void ParseAtom(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            tok = scanner.LookAhead(TokenType.NUMBER, TokenType.POINTER, TokenType.REFOPER, TokenType.IDENTIFIER, TokenType.LPAREN);
            switch (tok.Type)
            {
                case TokenType.NUMBER:
                    tok = scanner.Scan(TokenType.NUMBER);
                ...
                case TokenType.IDENTIFIER:
                    ...
                    tok = scanner.LookAhead(TokenType.POINTER, TokenType.REFOPER);
                    if (tok.Type == TokenType.POINTER
        ...
        private void ParseIncrement(ParseNode parent)
        {
           ...
           ParseNode n;
            ...
            if (tok.Type != TokenType.INCRE)
                tree.Errors.Add(new ParseError("Unexpected token '" + tok.Text.Replace("\n", "") + "' found. Expected " + TokenType.INCRE.ToString(), 0x1001, tok.LinePos, tok.ColumnPos, tok.StartPos, tok.Length));
            n = node.CreateNode(tok, tok.ToString() );
            node.Token.UpdateRange(tok);
            node.Nodes.Add(n);
